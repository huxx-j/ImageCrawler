...
//        public static void main(String args[]) {
    protected void imageCrawler(String cafeUrl, String naverId, String naverPw) throws InterruptedException {
            ...
            WebElement id = driver.findElement(By.id("id")); //아이디를 입력할 태그 위치 찾는 코드
            id.clear();
            id.sendKeys(naverId);
